module.exports = {
  ...
  body: p => {
    ...
    const nice_view_front = `
      ...
      //     (effects (font (size 1 1) (thickness 0.15)) (justify right))
      // )
      (fp_text user "GND" (at -2.54 -9.94 ${90 + p.rot}) (layer "F.SilkS")
          (effects (font (size 1 1) (thickness 0.15)) (justify right))
      )
    ...
    const nice_view_back = `
      ...
      //     (effects (font (size 1 1) (thickness 0.15)) (justify right mirror))
      // )
      (fp_text user "GND" (at 2.47 -9.94 ${-90 + p.rot}) (layer "B.SilkS")
    ...
    const nice_view_reversible = `
      (fp_text user "GND" (at -2.54 -6.44 ${90 + p.rot}) (layer "F.SilkS")
          (effects (font (size 1 1) (thickness 0.15)) (justify right))
      )
      (fp_text user "GND" (at 2.47 -3.44 ${-90 + p.rot}) (layer "B.SilkS")
          (effects (font (size 1 1) (thickness 0.15)) (justify right mirror))
      )
      ...
      (pad "" thru_hole circle (at 5.08 0 ${p.rot}) (size 1.7526 1.7526) (drill 1.0922) (layers "*.Cu" "*.Mask"))
      (pad 5 smd custom (at -5.08 -2.764 ${180 + p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.P4.str}
        (clearance 0.1) (zone_connect 0)
        (options (clearance outline) (anchor rect))
        (primitives
          (gr_poly
